...
test('V6.2 pair-specific stale-chop calibration is retired; repeated-loss logic is cross-track',()=>{
  loss('EURUSD');
  ...
  assert.equal(eur.features.streakStateVersion,'V6.3_CROSS_TRACK_REPEAT_STATE');
