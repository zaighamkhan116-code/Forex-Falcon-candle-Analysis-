...
export function applyForwardTrackCalibration(result,pair,horizon){
  ...
  const calibration={version:'V3_5_TARGETED_COMPOUND_RERANK',status:'FORWARD_VALIDATION',trigger,evidence,originalDirection:dir,rerankedDirection:newDirection,frequencyImpact:'NONE',globalThresholdChanged:false};
  return{result:{...result,direction:newDirection,evidenceScore:newEvidence,qualified:true,tradeQualified:true,minimumConfidence:BASE_THRESHOLD,features:{...f,...candidateTelemetry,lossStreakCalibrationVersion:'V3_5_TARGETED_COMPOUND_RERANK',lossStreakRerankApplied:true,lossStreakRerankTrigger:trigger,lossStreakRerankEvidence:evidence,lossStreakOriginalDirection:dir,lossStreakRerankedDirection:newDirection,lossStreakFrequencyImpact:'NONE',lossStreakConflictCount:breakoutProgressConflictCount,lossStreakRuntimeConflictCount:runtimeConflictCount}},calibration};
}
