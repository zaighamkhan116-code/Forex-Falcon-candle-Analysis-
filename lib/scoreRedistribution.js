...
export function assessScoreRedistribution(features={},risk={},direction='',horizon=1){
  ...
  const fvgResolvedConfirmed=fvgResolved&&!stalled&&progress>=3&&moveQuality>=5.5;
  ...
  if(fvgResolvedConfirmed){bonus+=1.5;bonusTags.push('FVG_RESOLVED_CONFIRMED')}
  ...
  return{
    ...
    stalePressure:penalty>=3,freshPressure:bonus>=2,freshBreakout,freshSweep,fvgResolved,fvgResolvedConfirmed,renewedProgress,renewedConsensus,cleanMtf,maBbAligned,
